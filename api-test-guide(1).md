...
> 生成日期: 2026-06-05  
> 基础地址配置:
> - **用户服务 (applet-api)**: `http://localhost:8888`
> - **文章服务 (article-api)**: `http://localhost:80`
> - **聊天服务 (chat-api)**: `http://localhost:8087` (WebSocket 协议: `ws://localhost:8087`)
> - **问答服务 (qa-api)**: `http://localhost:8890`
...
| 认证类型 | 客户端配置 (Header / Query) | 说明 |
| :--- | :--- | :--- |
| **无认证** | 无需额外参数 | 适用于公开注册、登录、验证码发送接口 |
| **JWT 鉴权** | `Authorization: Bearer <token>` | 在 Apifox 的 Auth 选项卡选择 `Bearer Token`，填入 `access_token` |
| **JWT + Signature** | `Authorization: Bearer <token>` 且携带签名头 | 在 JWT 认证的基础上增加防篡改签名校验（由 Gateway/Signature 中间件处理） |

**Token 获取流程**:  
1. 调用 `POST /v1/verification` 发送手机验证码。  
2. 调用 `POST /v1/login` 传入手机号及验证码，获取返回的 `access_token`。  
3. 将 `access_token` 填入全局变量或 Apifox 的 Auth 配置中以自动填充所有受限接口。

---

## 2. 用户服务 (applet-api)

* 服务基准地址：`http://localhost:8888`

### 2.1 用户注册

- **请求方式**: `POST`
- **请求 URL**: `http://localhost:8888/v1/register`
- **Apifox Auth 配置**: `无 (No Auth)`
- **Header 鉴权**: 无
- **Query 参数**: 无
- **Body 入参** (Content-Type: `application/json`):
  | 参数名 | 类型 | 必填 | 说明 |
  | :--- | :--- | :--- | :--- |
  | name | string | 是 | 用户名 |
  | mobile | string | 是 | 手机号 |
...
- **请求方式**: `POST`
- **请求 URL**: `http://localhost:8888/v1/verification`
- **Apifox Auth 配置**: `无 (No Auth)`
- **Header 鉴权**: 无
- **Query 参数**: 无
- **Body 入参** (Content-Type: `application/json`):
...
- **请求方式**: `POST`
- **请求 URL**: `http://localhost:8888/v1/login`
- **Apifox Auth 配置**: `无 (No Auth)`
- **Header 鉴权**: 无
- **Query 参数**: 无
- **Body 入参** (Content-Type: `application/json`):
...
- **请求方式**: `GET`
- **请求 URL**: `http://localhost:8888/v1/user/info`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
  | Authorization | string | 是 | Bearer {{access_token}} | JWT 认证 Token |
  | X-Signature | string | 是 | (自动计算) | 用于 API 签名校验 |
- **Query 参数**: 无 (从 Token 解析得到 userId)
- **Body 入参**: 无
...
- **请求方式**: `POST`
- **请求 URL**: `http://localhost:8888/v1/like/thumbup`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
- **请求方式**: `POST`
- **请求 URL**: `http://localhost:8888/v1/follow/follow`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
- **请求方式**: `POST`
- **请求 URL**: `http://localhost:8888/v1/follow/unfollow`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
- **请求方式**: `GET`
- **请求 URL**: `http://localhost:8888/v1/follow/list`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
- **请求方式**: `GET`
- **请求 URL**: `http://localhost:8888/v1/follow/fans`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
- **请求方式**: `GET`
- **请求 URL**: `http://localhost:8888/v1/message/list`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
- **请求方式**: `GET`
- **请求 URL**: `http://localhost:8888/v1/message/unread`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
- **请求方式**: `POST`
- **请求 URL**: `http://localhost:8888/v1/message/read`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
- **请求方式**: `POST`
- **请求 URL**: `http://localhost:8888/v1/message/readall`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
- **请求方式**: `POST`
- **请求 URL**: `http://localhost:8888/v1/concerned/add`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
- **请求方式**: `POST`
- **请求 URL**: `http://localhost:8888/v1/concerned/cancel`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
- **请求方式**: `GET`
- **请求 URL**: `http://localhost:8888/v1/concerned/check`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
- **请求方式**: `GET`
- **请求 URL**: `http://localhost:8888/v1/concerned/list`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
- **请求方式**: `GET`
- **请求 URL**: `http://localhost:8888/v1/member/info`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
- **请求方式**: `GET`
- **请求 URL**: `http://localhost:8888/v1/member/right`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
- **请求方式**: `POST`
- **请求 URL**: `http://localhost:8888/v1/tag/create`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
- **请求方式**: `POST`
- **请求 URL**: `http://localhost:8888/v1/tag/update`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
{
  "tag_id": 1001,
  "tag_name": "Go-Zero 核心实践",
  "tag_desc": "Go-Zero 深度解析"
}
```
...
- **请求方式**: `POST`
- **请求 URL**: `http://localhost:8888/v1/tag/delete`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
- **请求方式**: `GET`
- **请求 URL**: `http://localhost:8888/v1/tag/detail`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
- **请求方式**: `GET`
- **请求 URL**: `http://localhost:8888/v1/tag/list`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
- **请求方式**: `GET`
- **请求 URL**: `http://localhost:8888/v1/tag/hot`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
- **请求方式**: `POST`
- **请求 URL**: `http://localhost:8888/v1/tag/resource/add`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
- **请求方式**: `POST`
- **请求 URL**: `http://localhost:8888/v1/tag/resource/remove`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
- **请求方式**: `GET`
- **请求 URL**: `http://localhost:8888/v1/tag/resource/list`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
- **请求方式**: `GET`
- **请求 URL**: `http://localhost:8888/v1/tag/resource/tags`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
- **请求方式**: `POST`
- **请求 URL**: `http://localhost:8888/v1/reply/create`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
- **请求方式**: `POST`
- **请求 URL**: `http://localhost:8888/v1/reply/delete`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
- **请求方式**: `GET`
- **请求 URL**: `http://localhost:8888/v1/reply/detail`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
- **请求方式**: `GET`
- **请求 URL**: `http://localhost:8888/v1/reply/list`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
- **请求方式**: `GET`
- **请求 URL**: `http://localhost:8888/v1/reply/count`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
- **请求方式**: `GET`
- **请求 URL**: `http://localhost:8888/v1/concerned/count`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
- **请求方式**: `POST`
- **请求 URL**: `http://localhost:8888/v1/member/upgrade`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
- **请求方式**: `GET`
- **请求 URL**: `http://localhost:8888/v1/member/orders`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
* 服务基准地址：`http://localhost:80`

### 3.1 上传文章封面

- **请求方式**: `POST`
- **请求 URL**: `http://localhost:80/v1/article/upload/cover`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
  | Authorization | string | 是 | Bearer {{access_token}} | JWT 认证 Token |
- **Query 参数**: 无
- **Body 入参** (Content-Type: `multipart/form-data`):
  | 参数名 | 类型 | 必填 | 说明 |
  | :--- | :--- | :--- | :--- |
  | file | file | 是 | 图片文件 |
...
- **请求方式**: `POST`
- **请求 URL**: `http://localhost:80/v1/article/publish`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
- **请求方式**: `GET`
- **请求 URL**: `http://localhost:80/v1/article/detail`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
- **请求方式**: `GET`
- **请求 URL**: `http://localhost:80/v1/article/list`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
- **请求方式**: `GET`
- **请求 URL**: `http://localhost:80/v1/article/search`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
- **请求方式**: `POST`
- **请求 URL**: `http://localhost:80/v1/article/delete`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
- **请求方式**: `GET`
- **请求 URL**: `http://localhost:80/v1/article/all`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
| 用例 | 输入 | 期望结果 |
| :--- | :--- | :--- |
| 正常获取首页 | 不传参数 | 200, 返回最新公开文章列表 |
| 分页获取 | cursor=1001, page_size=10 | 200, 分页返回文章列表 |

---

## 4. 聊天服务 (chat-api)

* 服务基准地址：`http://localhost:8087`

### 4.1 会话列表

- **请求方式**: `GET`
- **请求 URL**: `http://localhost:8087/v1/chat/conversations`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
- **请求方式**: `GET`
- **请求 URL**: `http://localhost:8087/v1/chat/messages`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
- **请求方式**: `POST`
- **请求 URL**: `http://localhost:8087/v1/chat/send`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
- **请求方式**: `POST`
- **请求 URL**: `http://localhost:8087/v1/chat/markread`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
- **请求方式**: `GET`
- **请求 URL**: `http://localhost:8087/v1/chat/unread`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
- **请求方式**: `GET` (Connection Upgrade)
- **请求 URL**: `ws://localhost:8087/v1/chat/ws`
- **Apifox Auth 配置**: `无 (No Auth)` (使用 URL 传参进行 Token 校验)
- **Header 鉴权**: 无
- **Query 参数**:
  | 参数名 | 类型 | 必填 | 说明 |
  | :--- | :--- | :--- | :--- |
  | token | string | 是 | JWT Token |
- **Body 入参**: 无 (基于 WS 协议帧传输数据)

**建立连接 URL 示例**:
```
ws://localhost:8087/v1/chat/ws?token={{access_token}}
```
...
* 服务基准地址：`http://localhost:8890`

### 6.1 发布问题

- **请求方式**: `POST`
- **请求 URL**: `http://localhost:8890/v1/qa/publish`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
- **请求方式**: `POST`
- **请求 URL**: `http://localhost:8890/v1/qa/answer`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
{
  "question_id": 3001,
  "content": "可以在 etc/xxx.yaml 中配置 Redis..."
}
```
...
- **请求方式**: `POST`
- **请求 URL**: `http://localhost:8890/v1/qa/accept`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
- **请求方式**: `GET`
- **请求 URL**: `http://localhost:8890/v1/qa/list`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
- **请求方式**: `GET`
- **请求 URL**: `http://localhost:8890/v1/qa/detail`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
- **请求方式**: `POST`
- **请求 URL**: `http://localhost:8890/v1/qa/delete`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
- **请求方式**: `GET`
- **请求 URL**: `http://localhost:8890/v1/qa/answers`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
- **请求方式**: `POST`
- **请求 URL**: `http://localhost:8890/v1/qa/answer/delete`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
...
- **请求方式**: `GET`
- **请求 URL**: `http://localhost:8890/v1/qa/search`
- **Apifox Auth 配置**: `继承父级 (Bearer Token)`
- **Header 鉴权**:
  | 参数名 | 类型 | 必填 | 示例值 | 说明 |
  | :--- | :--- | :--- | :--- | :--- |
